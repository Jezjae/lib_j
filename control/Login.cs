        ...
        public void logIn()
        {
            ...
            while (isOutCheck == false)
            {
                ...
                if (num == "1")
                {
                    ...
                    while (isBack == false)
                    {
                        ...
                        if (num2 == "1")
                        {
                            ...
                            Console.WriteLine();
                            Console.WriteLine();
                            Console.Write("   뒤로가기는 'Enter'를, 처음 메뉴로 돌아가기는 '1'을 입력해 주세요. : ");
                ...
                else if (num == "4")
                {
                    ...
                    Console.WriteLine();
                    Console.WriteLine();
                    Console.Write("   뒤로가기 'Enter'를, 처음 메뉴로 돌아가기는 '1'을 입력해 주세요. : ");
                    string outNum = Console.ReadLine();
                ...
                else if (num == "5")
                {
                    ...
                    for (int i = 0; i < Library.memberList.Count; i++)
                    {
                        if (Library.memberList[i].Id == tempId)
                        {
                            ...
                            Console.WriteLine();
                            Console.WriteLine();
                            Console.WriteLine("   뒤로가기 'Enter'를, 처음 메뉴로 돌아가기는 '1'번을,");
                            Console.WriteLine();
